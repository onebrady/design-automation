...
async function main() {
  ...
  app.post('/api/design/enhance-cached', express.json(), async (req, res) => {
    ...
    const out = enhanceCached({ code, tokens, filePath: body.filePath || '', brandPackId: resolvedBrandPackId || body.brandPackId || '', brandVersion: body.brandVersion || '', componentType });
